...
import { isNotNil } from 'ng-zorro-antd/src/core/util/check';
import { reqAnimFrame } from 'ng-zorro-antd/src/core/polyfill/request-animation';
import { UpdateHostClassService } from '@common/modules/time-picker/update-class-service';
...
export class TimePickerPanelComponent implements ControlValueAccessor, OnInit, OnDestroy {
  ...
  @ViewChild(TimeValueAccessorDirective) nzTimeValueAccessorDirective: TimeValueAccessorDirective;
  ...
  constructor(private element: ElementRef, private updateCls: UpdateHostClassService) {
  }
