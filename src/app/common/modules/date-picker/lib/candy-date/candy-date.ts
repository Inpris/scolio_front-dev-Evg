...
import { customParsersFromFormat, firstDayOfWeek } from './util';
...
export class CandyDate {
  ...
  constructor(date?: Date | string, format?: string) {
    ...
    if (date instanceof Date) {
      ...
      const parser = customParsersFromFormat[format];
      this.nativeDate = parser && parser(date) || new Date(date);
    } else {
        ...
        case 'second':
          return (left.getFullYear() > right.getFullYear())
            ...
            || (left.getFullYear() === right.getFullYear()
              ...
              && left.getHours() === right.getHours() && left.getMinutes() > right.getMinutes())
            || (left.getFullYear() === right.getFullYear() && left.getMonth() === right.getMonth()
              && left.getDate() === right.getDate() && left.getHours() === right.getHours() && left.getMinutes() === right.getMinutes() && left.getSeconds() > right.getSeconds());
      }
    }
    return false;
  }
      ...
      switch (grain) {
        ...
        case 'minute':
          return (left.getFullYear() < right.getFullYear())
            ...
            || (left.getFullYear() === right.getFullYear() && left.getMonth() === right.getMonth() && left.getDate() === right.getDate() && left.getHours() < right.getHours())
            || (left.getFullYear() === right.getFullYear() && left.getMonth() === right.getMonth()
              && left.getDate() === right.getDate() && left.getHours() === right.getHours() && left.getMinutes() < right.getMinutes());
        case 'second':
          return (left.getFullYear() < right.getFullYear())
            || (left.getFullYear() === right.getFullYear() && left.getMonth() < right.getMonth())
            || (left.getFullYear() === right.getFullYear() && left.getMonth() === right.getMonth() && left.getDate() < right.getDate())
